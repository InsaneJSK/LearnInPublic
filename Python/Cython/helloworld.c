...
#define __pyx_kp_u_Hello_World __pyx_string_tab[1]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[2]
#define __pyx_n_u_end __pyx_string_tab[3]
...
#define __pyx_n_u_print __pyx_string_tab[8]
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "helloworld" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_helloworld", 0);
 ...
 * print("Hello World!")             # <<<<<<<<<<<<<<
*/
  if (__Pyx_PrintOne(0, __pyx_mstate_global->__pyx_kp_u_Hello_World) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_Hello_World, sizeof(__pyx_k_Hello_World), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_Hello_World */
